...
from utils.prompt import SCOPE_CLASSIFIER_PROMPT, GROUP_RELEVANCE_JUDGE_PROMPT_BIN, QUERY_EXPANDER_PROMPT, TASK_HEADER, CORE_SYNTHESIS_INSTRUCTIONS, RETRY_PROMPTS
...
from .evaluation.confidence2 import evaluate_grounding_quality, evaluate_confidence_profile
...
class RAGPipeline:
    ...
    def run(self, request: QueryRequest):
        ...
        try:
            ...
            relevance_scores = self.evidence_relevance_judge.judge_relevance_unified(user_query, texts, GROUP_RELEVANCE_JUDGE_PROMPT_BIN)
